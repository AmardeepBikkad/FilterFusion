        ...
        if let view = recognizer.view {
            if view is UIImageView {
                ...
                if recognizer.state == .began {
                    for imageView in subImageViews(view: selectedImageView) {
...
//        
//        view.center = CGPoint(x: view.center.x + recognizer.translation(in: selectedImageView).x,
//                              y: view.center.y + recognizer.translation(in: selectedImageView).y)
//        
//        recognizer.setTranslation(CGPoint.zero, in: selectedImageView)
//        
...
//                    view.center = recognizer.location(in: self.selectedImageView)
//                })
//            }
...
//                }
//            } else if !selectedImageView.bounds.contains(view.center) { //Snap the view back to canvasImageView
//                UIView.animate(withDuration: 0.3, animations: {
//                    print(self.selectedImageView.center)
//                    print(view.center)
//                    view.center = self.selectedImageView.center
//                })
//                
//            }
//        }
